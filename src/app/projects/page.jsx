  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-2 overflow-hidden md:p-8">
      ...
      <div className="w-[100%] md:pl-10">
        <h1 className="text-xl md:text-2xl lg:text-4xl text-center md:text-left mb-3">
      ...
      <div className="flex flex-col justify-center items-center p-3 rounded-lg border-[#d4d4d4] border-[0.7px] shadow-md backdrop-blur-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 grid-flow-row m-8 lg:max-w-6xl max-h-[500px] lg:max-h-[600px] overflow-x-hidden">
        ...
        <div className="w-[100%] flex justify-center items-center z-[1] pb-3">
            <Link
